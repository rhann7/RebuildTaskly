export const getProjectColumns = (workspaceSlug: string) => [
    {
        ...
        data: "name",
        // w-full di sini kunci agar tabel tidak nyempit
        ...
        render: (data: any, type: any, row: any) => `
            <div class="flex items-center gap-4 group/item">
                ...
                <div class="flex flex-col">
                    <a href="/workspaces/${workspaceSlug}/projects/${row.slug}" class="font-black text-[13px] uppercase tracking-tight text-white line-clamp-1 hover:text-red-500 transition-colors italic">
                        ${row.name}
                    </a>
                    ...
                    <div class="flex items-center gap-2 mt-1">
                         <span class="text-[8px] font-black px-1.5 py-0.5 rounded bg-blue-500/10 text-blue-400 border border-blue-500/20 uppercase tracking-[0.2em]">IN PROGRESS</span>
                    </div>
                </div>
            </div>
        `
    },
    {
        header: "STATUS",
        data: "status",
        // Kolom ini jangan dikasih w-full, kasih lebar fixed
        className: "px-6 whitespace-nowrap text-center w-[150px]",
        render: (data: any) => `
    ...
    },
    {
        ...
        render: (data: any) => `
            <div class="flex justify-end pr-2">
                <a href="/workspaces/${workspaceSlug}/projects/${data}" class="size-10 inline-flex items-center justify-center rounded-xl bg-zinc-800/50 hover:bg-red-600 text-white transition-all border border-white/5 hover:scale-110 active:scale-95 shadow-lg">

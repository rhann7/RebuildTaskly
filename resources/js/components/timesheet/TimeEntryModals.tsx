...
export function TimeEntryModal({ 
    isOpen, setIsOpen, data, setData, projects, processing, errors, workspace, isEditing 
}: any) {
            ...
            <Dialog open={isOpen} onOpenChange={(open) => {
                ...
                <DialogContent className="max-w-2xl bg-white border border-border rounded-[24px] p-0 shadow-2xl outline-none overflow-hidden flex flex-col sm:rounded-[24px]">
                    ...
                    <DialogHeader className="flex flex-row items-center justify-between p-6 border-b border-border">
                        <DialogTitle className="text-xl font-bold text-foreground">Time Entry</DialogTitle>
                        <DialogClose className="text-muted-foreground hover:text-foreground transition-colors rounded-full p-1 hover:bg-muted">
                        </DialogClose>
                    </DialogHeader>
